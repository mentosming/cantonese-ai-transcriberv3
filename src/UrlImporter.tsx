...
import { Link2, Download, Loader2, AlertCircle, CheckCircle2, Globe, ExternalLink, HelpCircle, FileVideo, FileAudio, ArrowRight } from 'lucide-react';
